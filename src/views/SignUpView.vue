                        ...
                        <div class="col-md-10 col-lg-6 col-xl-6 order-2 order-lg-1">
                            ...
                            <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <input type="text" id="form3Example1c" class="form-control" placeholder="Your Full Name"  v-model="name" />
                                </div>
                            </div>
                            ...
                            <i class="fa-regular fa-user fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <input type="text" id="form3Example2c" class="form-control" placeholder="Username"   v-model="username" />
                                </div>
                            </div>
                            ...
                            <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <input type="email" id="form3Example3c" class="form-control" placeholder="Email"    v-model="email"/>
                                </div>
                            </div>
                            ...
                            <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <input type="password" id="form3Example4c" class="form-control" placeholder="Password" v-model="password.password" />
                                </div>
                            </div>
                            ...
                            <i class="fas fa-key fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <input type="password" id="form3Example4cd" class="form-control" placeholder="Repeat Password" v-model="password.confirm"/>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                <button class="container__btn2 mx-0 mb-3 w-100" @click="submitForm">Register</button>
                            </div>
